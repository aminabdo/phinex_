...
class DoctorLanding {
  ...
  static DoctorLanding fromMap(Map<String, dynamic> map) {
    if (map == null) return null;
    DoctorLanding doctorLandingBean = DoctorLanding();
    doctorLandingBean.data = DataBean.fromMap(map['data']);
    doctorLandingBean.message = map['message'];
    doctorLandingBean.code = map['code'];
    return doctorLandingBean;
  }
...
/// doctors-specialties : [{"id":209,"name":"Immunologists","description":"Immunologists","keywords":"Immunologists","icon":null,"parent_id":13,"deleted_at":null,"created_at":"2020-09-20T12:02:51.000000Z","updated_at":"2020-09-20T12:02:51.000000Z","image_url":"https://images.phinex.net/storage/app/public/images/2020-09/20-Sun/immunologists.jpeg","dotctors":[]},{"id":720,"name":"Spinal Surgery ","description":",","keywords":",","icon":null,"parent_id":13,"deleted_at":null,"created_at":"2020-10-07T12:42:16.000000Z","updated_at":"2020-10-07T12:42:16.000000Z","image_url":"https://images.phinex.net/storage/app/public/images/2020-10/07-Wed/spinal_surgery.png","dotctors":[]},{"id":201,"name":"Dermatologists","description":"Dermatologists","keywords":"Dermatologists","icon":null,"parent_id":13,"deleted_at":null,"created_at":"2020-09-20T11:10:41.000000Z","updated_at":"2020-09-20T11:10:41.000000Z","image_url":"https://images.phinex.net/storage/app/public/images/2020-09/20-Sun/dermatologists.jpeg","dotctors":[{"id":45,"doctor_id":335,"category_id":201,"commercial_name":"sddss","home_visit":1,"degree":"specialist","short_description":"asdsad","description":"asdsad","website":null,"email":null,"city":15420,"governorate":1048,"country":64,"total_reviews":0,"total_rates":0,"status":"pending","created_at":"2020-11-18 13:27:46","updated_at":"2020-11-18 13:27:46","deleted_at":null,"image_url":"https://images.phinex.net/storage/app/public/images/2020-11/18-Wed/sddss.jpeg"}]},{"id":685,"name":"Gynaecology and Infertility","description":",","keywords":",","icon":null,"parent_id":13,"deleted_at":null,"created_at":"2020-10-07T12:35:04.000000Z","updated_at":"2020-10-07T12:35:04.000000Z","image_url":"https://images.phinex.net/storage/app/public/images/2020-10/07-Wed/gynaecology_and_infertility.png","dotctors":[]},{"id":713,"name":"Osteopathy","description":",","keywords":",","icon":null,"parent_id":13,"deleted_at":null,"created_at":"2020-10-07T12:41:15.000000Z","updated_at":"2020-10-07T12:41:15.000000Z","image_url":"https://images.phinex.net/storage/app/public/images/2020-10/07-Wed/osteopathy.png","dotctors":[]},{"id":712,"name":"Ophthalmology","description":",","keywords":",","icon":null,"parent_id":13,"deleted_at":null,"created_at":"2020-10-07T12:41:06.000000Z","updated_at":"2020-10-07T12:41:06.000000Z","image_url":"https://images.phinex.net/storage/app/public/images/2020-10/07-Wed/ophthalmology.png","dotctors":[]}]
...
class DataBean {
  List<DoctorsSpecialtiesBean> doctors_specialties;
  List<SpecialtiesBean> specialties;

  static DataBean fromMap(Map<String, dynamic> map) {
    if (map == null) return null;
    DataBean dataBean = DataBean();
    dataBean.doctors_specialties = List()..addAll(
        (map['doctors-specialties'] as List ?? []).map((o) => DoctorsSpecialtiesBean.fromMap(o))
    );
  ...
  Map toJson() => {
    "doctors-specialties": doctors_specialties,
...
/// keywords : "Immunologists"
/// icon : null
/// parent_id : 13
/// deleted_at : null
/// created_at : "2020-09-20T12:02:51.000000Z"
/// updated_at : "2020-09-20T12:02:51.000000Z"
/// image_url : "https://images.phinex.net/storage/app/public/images/2020-09/20-Sun/immunologists.jpeg"
/// dotctors : []
class DoctorsSpecialtiesBean {
  int id;
  String name;
  String description;
  String keywords;
  ...
  String updatedAt;
  String imageUrl;
  List<CommonBean> dotctors;

  static DoctorsSpecialtiesBean fromMap(Map<String, dynamic> map) {
    if (map == null) return null;
    DoctorsSpecialtiesBean doctors_specialtiesBean = DoctorsSpecialtiesBean();
    doctors_specialtiesBean.id = map['id'];
    doctors_specialtiesBean.name = map['name'];
    doctors_specialtiesBean.description = map['description'];
    doctors_specialtiesBean.keywords = map['keywords'];
    doctors_specialtiesBean.icon = map['icon'];
    doctors_specialtiesBean.parentId = map['parent_id'];
    doctors_specialtiesBean.deletedAt = map['deleted_at'];
    doctors_specialtiesBean.createdAt = map['created_at'];
    doctors_specialtiesBean.updatedAt = map['updated_at'];
    doctors_specialtiesBean.imageUrl = map['image_url'];
    doctors_specialtiesBean.dotctors = List()..addAll(
        (map['doctors'] as List ?? []).map((o) => CommonBean.fromMap(o))
    );
    return doctors_specialtiesBean;
  }

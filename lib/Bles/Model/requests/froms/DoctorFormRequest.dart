...
class DoctorFormRequest {
  ...
  Map toJson() {
    ...
    map.addAll(listToLangMap(langDoctor));
    return map;
  }

  Map listToLangMap(List<LangDoctor> langs) {
    Map<String, LangDoctor> map = Map();
    if(langs == null) {
      langs = [];
    }
...
class Hospitals {
  ...
  Map toJson() {
    ...
    map.addAll(listToLangMap(langHospital));
    return map;
  }

  Map listToLangMap(List<LangClinic> langs) {
    Map<String, LangClinic> map = Map();
    langs.forEach((element) {
      map.addAll({element.lang: element});
    });
...
class LangClinic {
  ...
  LangClinic({this.lang, this.title, this.address, this.description});

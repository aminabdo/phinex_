...
class _AddCompanyPageState extends State<AddCompanyPage> {
  ...
  String business_descriptionErrorMsg = '';
        ...
        child: LoadingOverlay(
          ...
          child: StreamBuilder<IndexLandingResponse>(
            ...
            builder: (context, snapshot) {
              if (indexBloc.loading.value) {
                return Loader();
              } else {
                if (!gotData) {
                  indexBloc.landing.value.data.forEach((element) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              MyTextFormField(
                                ...
                                maxLines: 5,
                                keyboardType: TextInputType.multiline,
                                errorMessage: business_descriptionErrorMsg,
                              ...
                              myButton(
                                ...
                                btnColor: mainColor,
                                onTap: () {
                                  validateAndCreateNewIndex(context);
                                },
                              ),
                              SizedBox(
  ...
  void validateAndCreateNewIndex(BuildContext context) async {
    ...
    if (businessDescriptionContrller.text.isEmpty) {
      business_descriptionErrorMsg =
          AppLocalization.of(context).translate("required");
    } else if (businessDescriptionContrller.text.length < 2) {
      business_descriptionErrorMsg =
          AppLocalization.of(context).translate("name_length_not_valid");
    } else {
      business_descriptionErrorMsg = null;
    }
    ...
    if (businessActivityErrorMsg == null &&
      ...
      CreateCatalougeFormRequest request = CreateCatalougeFormRequest(
        ...
        categoryId: indexBloc.landing.value.data.firstWhere((element) => element.name == selectedCategory).id.toString(),
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        AppUtils.showToast(msg: response.data['message'].toString());
      }
    }
  }
}

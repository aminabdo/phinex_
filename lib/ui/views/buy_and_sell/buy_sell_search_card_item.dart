...
class BuySellSearchCartItem extends StatefulWidget {
  final BuySellDataResult productsBean;

  const BuySellSearchCartItem({
    Key key,
    this.productsBean,
  }) : super(key: key);

  @override
  _BuySellSearchCartItemState createState() => _BuySellSearchCartItemState();
}

class _BuySellSearchCartItemState extends State<BuySellSearchCartItem> {
  @override

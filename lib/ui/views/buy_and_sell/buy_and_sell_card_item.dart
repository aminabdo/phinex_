...
class BuySellCartItem extends StatefulWidget {
  final ItemsBean productsBean;

  const BuySellCartItem({
    Key key,
    this.productsBean,
  }) : super(key: key);

  @override
  _BuySellCartItemState createState() => _BuySellCartItemState();
}

class _BuySellCartItemState extends State<BuySellCartItem> {
  @override

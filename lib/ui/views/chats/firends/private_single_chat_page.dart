...
//   final String name;
//
//   PrivateChatPage({Key key, @required this.id, @required this.name}) : super(key: key) ;
//
//   initPusher() async {
//     await chatBloc.connect();
//     await chatBloc.subscribe(id);
//     await chatBloc.bind();
//   }
//
//   disPusher() async {
//     await chatBloc.unbind();
//     await chatBloc.unsubscribe(id);
...
//
//       if(chatBloc.subLoading.value ==true){
//         return;
//       }
//
//
//       chatBloc.getMessagesChat(BaseRequestSkipTake(
//         id: widget.id,
//         take: take ,
//         skip: skip+= 50,
//       ));
...
//               return Loader();
//             } else {
//               print("chatBloc.chat.stream");
//               print(chatBloc.chat.value);
//               return Column(
//                 children: [
//                   SizedBox(
...
//                       ),
//                       onPressed: () {
//                         if (snapshot.data.subscriptions.length >= 2) {
//                           int id;
//                           String title;
//                           if (snapshot.data.subscriptions[0].id ==
//                               AppUtils.userData.id) {
//                             id = snapshot.data.subscriptions[1].id;
//                             title = snapshot.data.subscriptions[1].username;
//                           } else {
//                             id = snapshot.data.subscriptions[0].id;
//                             title = snapshot.data.subscriptions[0].username;
//                           }
...
//
//                         // my messages
//                         if (snapshot.data.messages[snapshot.data.messages.length - index - 1].userId.toString() ==
//                             AppUtils.userData.id.toString()) {
//
//                           // no content no attachment
//                           if(snapshot.data.messages[snapshot.data.messages.length - index - 1].content == '' &&
//                               snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment == null) {
//
//                             if(fileType != null) {
//                               if(fileType == 'image') {
//                                 return myWidget(
//                                   Column(children: [
//                                     buildTempImage(file),
//                                     buildText(snapshot.data.messages[snapshot.data.messages.length - index - 1].content),
//                                   ],),
//                                   snapshot.data.messages[snapshot.data.messages.length - index - 1].createdAt,
//                                 );
//
//                               } else {
//                                 return myWidget(
...
//                           }
//
//                           else if(snapshot.data.messages[snapshot.data.messages.length - index - 1].content == '' &&
//                               snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment != null){
//                             if(snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment.type == 'image') {
//                               // image
//                               return myWidget(
//                                   buildImage(snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment.content),
//                                   snapshot.data.messages[snapshot.data.messages.length - index - 1].createdAt,
//                               );
//
//                             } else {
//                               // video
//                               return myWidget(
//                                   buildVideo(snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment.content),
//                                 snapshot.data.messages[snapshot.data.messages.length - index - 1].createdAt,
//                               );
//                             }
//                           }
...
//                           if(snapshot.data.messages[snapshot.data.messages.length - index - 1].content != '' &&
//                               snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment != null &&
//                               snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment.type == 'image'
//                           ) {
//                             return myWidget(
//                               Column(
//                                 children: [
...
//                           if(snapshot.data.messages[snapshot.data.messages.length - index - 1].content != '' &&
//                               snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment != null &&
//                               snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment.type == 'video'
//                           ) {
//                             return myWidget(
//                               Column(
//                                 children: [
...
//                         // the sender messages  ===============================================================================
//                         else {
//                           dynamic userID = snapshot.data.messages[snapshot.data.messages.length - index - 1].userId;
//                           Subscriptions i = snapshot.data.subscriptions.firstWhere((element) => userID.toString() == element.id.toString());
//
//                           if(snapshot.data.messages[snapshot.data.messages.length - index - 1].content != '' && snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment == null) {
//                             return senderWidget(
//                               buildText(snapshot.data.messages[snapshot.data.messages.length - index - 1].content),
//                               snapshot.data.messages[snapshot.data.messages.length - index - 1].createdAt,
//                               i.username,
...
//                             );
//                           }
//                           else if(snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment != null &&
//                               snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment.type == 'image') {
//                             return senderWidget(
//                               buildImage(snapshot.data.messages[snapshot.data.messages.length - index - 1].attachment.content),
//                               snapshot.data.messages[snapshot.data.messages.length - index - 1].createdAt,
...
//   }
//
//   Widget senderWidget(Widget child, String date, String username, int userId) {
//     return Padding(
...
//     } else {
//       return FittedBox(child: Chewie(controller: chewieController,), fit: BoxFit.fill,);
//     }
//   }
// }
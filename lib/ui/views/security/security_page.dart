...
import 'package:phinex/ui/views/security/add_security_page.dart';
...
import 'sercurity_categories_page.dart';
...
class _SecurityPageState extends State<SecurityPage> {
  ...
  void initState() {
    ...
    catalogueBloc.getLanding(AppUtils.catalogueParent['security']);
  }
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (_) => AddSecurityPage()));
            },
          ),
        ],
        onBackBtnClicked: () {
                                    ...
                                    myButton(
                                      ...
                                      onTap: () {
                                        Provider.of<PageProvider>(context,
                                                listen: false)
                                            .setPage(
                                          SecurityCategoriesPage.pageIndex,
                                          SecurityCategoriesPage(
                                            categoryId:

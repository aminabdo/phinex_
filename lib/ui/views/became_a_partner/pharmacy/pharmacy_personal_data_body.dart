...
import 'pharmacy_regiteration_page.dart';

class PharmacyPersonalDataBody extends StatefulWidget {
  @override
  _PharmacyPersonalDataBodyState createState() =>
      _PharmacyPersonalDataBodyState();
}

class _PharmacyPersonalDataBodyState extends State<PharmacyPersonalDataBody> {
  File imageFile;
        ...
        if (generalBloc.loading.value) {
          ...
          if (snapshot.hasData && snapshot.data != null) {
            if (!gotData) {
              ...
              PharmacyRegisterationPage.pharmacyRequest = PharmaCistFormRequest();
              PharmacyRegisterationPage.pharmacyRequest.city = num.parse(selectedCityId);
              PharmacyRegisterationPage.pharmacyRequest.governorate = num.parse(selectedGovernorateId);
          ...
          return Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: MyTextFormField(
                      ...
                      onChanged: (String input) {
                        PharmacyRegisterationPage.pharmacyRequest.firstName =
                            input;
                      },
                    ),
                  ),
                  ...
                  Expanded(
                    child: MyTextFormField(
                      ...
                      onChanged: (String input) {
                        PharmacyRegisterationPage.pharmacyRequest.lastName =
                            input;
                      },
                    ),
                  ),
              ...
              MyTextFormField(
                ...
                onChanged: (String input) {
                  PharmacyRegisterationPage.pharmacyRequest.address = input;
                },
              ...
              MyTextFormField(
                ...
                onChanged: (String input) {
                  PharmacyRegisterationPage.pharmacyRequest.phone = input;
                },
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    onChanged: (newValue) {
                      ...
                      selectedGovernorateId = currentGovernorate.id.toString();
                      PharmacyRegisterationPage.pharmacyRequest.governorate = int.parse(selectedCityId);
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    onChanged: (newValue) {
                      ...
                      PharmacyRegisterationPage.pharmacyRequest.city = int.parse(selectedCityId);
                      setState(() {});
                    },
                  ),
                ),
    ...
    if (permissionIsGranted) {
      try {
        ...
        if (selectedImage != null) {
          ...
          imageFile = File(path);
          PharmacyRegisterationPage.pharmacyRequest.profileImage = imageFile;
          setState(() {});
        }
      } catch (e) {
        print(e);
  ...
  void checkValuesAndContinue() {
    ...
    if (firstNameErrorMsg == null &&
      ...
      pharmacyProvider.setCurrentIndicatorNumber(2);
    }
  }
}

...
class SubscribedLotsPage extends StatefulWidget {
  static final int pageIndex = 4;

  @override
  _SubscribedLotsPageState createState() => _SubscribedLotsPageState();
}

class _SubscribedLotsPageState extends State<SubscribedLotsPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: myAppBar(
        AppLocalization.of(context).translate('subscribed_lots'),
        context,
        onBackBtnClicked: () {

...
class FestivalCategoriesPage extends StatefulWidget {
  static final int pageIndex = 0;
  final int categoryId;
  final String categoryName;

  const FestivalCategoriesPage(
      {Key key, @required this.categoryId, @required this.categoryName})
      : super(key: key);

  @override
  _FestivalCategoriesPageState createState() =>
      _FestivalCategoriesPageState();
}

class _FestivalCategoriesPageState extends State<FestivalCategoriesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: myAppBar(
        ...
        context,
        onBackBtnClicked: () {
          Provider.of<PageProvider>(context, listen: false).setPage(FestivalPage.pageIndex, FestivalPage());
        },
      ),
      body: WillPopScope(
        onWillPop: () async {
          Provider.of<PageProvider>(context, listen: false)
              .setPage(FestivalPage.pageIndex, FestivalPage());
          return false;
        },

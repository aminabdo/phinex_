...
class FestivalDetailsPage extends StatefulWidget {
  ...
  const FestivalDetailsPage({Key key, @required this.id, @required this.title})
      : super(key: key);

  @override
  _FestivalDetailsPageState createState() => _FestivalDetailsPageState();
}
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      title: Row(
                        ...
                        children: [
                          Text(widget.title),
                          // todo should return festival reviews
                          RatingBar.builder(
                            initialRating: 4,
                            minRating: 1,
                            itemSize: 14,

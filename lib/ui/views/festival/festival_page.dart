...
import 'add_festival_page.dart';
import 'festival_categories_page.dart';
...
class _FestivalPageState extends State<FestivalPage> {
  ...
  void initState() {
    ...
    catalogueBloc.getLanding(AppUtils.catalogueParent['festival']);
  }
      ...
      appBar: myAppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(builder: (_) => AddFestivalPage()));
            },
          ),
        ],
        onBackBtnClicked: () {
                                    ...
                                    myButton(
                                      ...
                                      onTap: () {
                                        Provider.of<PageProvider>(context,
                                                listen: false)
                                            .setPage(
                                          FestivalCategoriesPage.pageIndex,
                                          FestivalCategoriesPage(
                                            categoryId:

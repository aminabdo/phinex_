...
import '../../../Bles/Model/requests/rate/MakeRateRequest.dart';
import '../../../Bles/Model/requests/taxi_client/ChangeRideStatusRequest.dart';
import '../../../Bles/Model/requests/taxi_client/MakeRideRequest.dart';
import '../../../Bles/Model/responses/taxi_client/BaseRideResponse.dart';
import '../../../Bles/bloc/taxi/TaxiRideBloc.dart';
import '../../../providers/page_provider.dart';
import '../../../utils/app_utils.dart';
import '../../../utils/consts.dart';
import '../../../utils/location_utils.dart';
import '../../widgets/driver_loading_effect.dart';
...
class _MainDriverPageState extends State<MainDriverPage> {
  ...
  void askPermission() async {
    ...
    var permissionIsGranted = await AppUtils.checkPermissionState(PermissionGroup.location);
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return ResponseCartItem(
                                  currentRequest: taxiBloc.ride.value.data.ride.rideReply[index],
                                  onRejectBtntapped: () async {
                                    await taxiBloc.changeRideReply(
                                        ChangeRideStatusRequest(
                                            userId: AppUtils.userData.id,
                                            status: "rejected",
                                            id: taxiBloc.ride.value.data.ride.rideReply[index].id,
                                  ...
                                  onAcceptOfferBtnClicked: (PolylineResult points) async {

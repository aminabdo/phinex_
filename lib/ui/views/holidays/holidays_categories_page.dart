...
import 'holidays_details_page.dart';
import 'holidays_page.dart';

class HolidaysCategoriesPage extends StatefulWidget {
  static final int pageIndex = 0;
  final int categoryId;
  final String categoryName;

  const HolidaysCategoriesPage(
      {Key key, @required this.categoryId, @required this.categoryName})
      : super(key: key);

  @override
  _HolidaysCategoriesPageState createState() =>
      _HolidaysCategoriesPageState();
}

class _HolidaysCategoriesPageState extends State<HolidaysCategoriesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: myAppBar(
        ...
        context,
        onBackBtnClicked: () {
          Provider.of<PageProvider>(context, listen: false).setPage(HolidaysPage.pageIndex, HolidaysPage());
        },
      ),
      body: WillPopScope(
        onWillPop: () async {
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      snapshot.data.data[index].website ?? AppLocalization.of(context).translate('no_website'),
                                      style: TextStyle(

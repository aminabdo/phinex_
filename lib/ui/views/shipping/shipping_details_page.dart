...
class ShippingDetailsDetailsPage extends StatefulWidget {
  final int id;
  final String title;

  const ShippingDetailsDetailsPage({Key key, @required this.id, @required this.title})
      : super(key: key);

  @override
  _ShippingDetailsDetailsPageState createState() => _ShippingDetailsDetailsPageState();
}

class _ShippingDetailsDetailsPageState extends State<ShippingDetailsDetailsPage> {
  @override
  void initState() {
    super.initState();
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      title: Row(
                        ...
                        children: [
                          Text(widget.title),
                          // todo should return restaurant reviews
                          RatingBar.builder(
                            initialRating: 4,
                            minRating: 1,
                            itemSize: 14,

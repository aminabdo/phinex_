...
import 'shipping_details_page.dart';

class ShippingCategoriesPage extends StatefulWidget {
  static final int pageIndex = 0;
  final int categoryId;
  final String categoryName;

  const ShippingCategoriesPage(
      {Key key, @required this.categoryId, @required this.categoryName})
      : super(key: key);

  @override
  _ShippingCategoriesPageState createState() =>
      _ShippingCategoriesPageState();
}

class _ShippingCategoriesPageState extends State<ShippingCategoriesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: myAppBar(
        ...
        context,
        onBackBtnClicked: () {
          Provider.of<PageProvider>(context, listen: false).setPage(ShippingPage.pageIndex, ShippingPage());
        },
      ),
      body: WillPopScope(
        onWillPop: () async {

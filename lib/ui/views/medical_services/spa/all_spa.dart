...
import 'spa_details_page.dart';

class AllSpa extends StatefulWidget {
  static final int pageIndex = 0;

  @override
  _AllSpaState createState() => _AllSpaState();
}

class _AllSpaState extends State<AllSpa> {
  int topCategoryTag = 2;

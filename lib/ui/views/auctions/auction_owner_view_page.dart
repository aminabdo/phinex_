...
// }
//
// class AuctionOwnerViewPage extends StatefulWidget {
//   final int id;
//   final String name;
//
//   const AuctionOwnerViewPage({Key key, @required this.id, @required this.name})
//       : super(key: key);
//
//   @override
//   _AuctionOwnerViewPageState createState() => _AuctionOwnerViewPageState();
// }
//
// class _AuctionOwnerViewPageState extends State<AuctionOwnerViewPage> {
//   bool readMore = false;

...
import 'package:phinex/ui/views/sports/sports_categories_page.dart';
...
import 'package:phinex/ui/views/sports/add_sports_page.dart';
...
class _SportsPageState extends State<SportsPage> {
  ...
  void initState() {
    ...
    catalogueBloc.getLanding(AppUtils.catalogueParent['sports']);
  }
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          Provider.of<PageProvider>(context,
                                              listen: false)
                                              .setPage(
                                            SportsCategoriesPage.pageIndex,

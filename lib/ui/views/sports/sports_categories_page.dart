...
import 'package:phinex/ui/views/sports/sport_details_page.dart';
...
class SportsCategoriesPage extends StatefulWidget {
  static final int pageIndex = 0;
  final int categoryId;
  final String categoryName;

  const SportsCategoriesPage(
      {Key key, @required this.categoryId, @required this.categoryName})
      : super(key: key);

  @override
  _SportsCategoriesPageState createState() =>
      _SportsCategoriesPageState();
}

class _SportsCategoriesPageState extends State<SportsCategoriesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: myAppBar(
        ...
        context,
        onBackBtnClicked: () {
          Provider.of<PageProvider>(context, listen: false).setPage(SportsPage.pageIndex, SportsPage());
        },
      ),
      body: WillPopScope(
        onWillPop: () async {
          Provider.of<PageProvider>(context, listen: false)
              .setPage(SportsPage.pageIndex, SportsPage());
          return false;
        },

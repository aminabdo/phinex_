...
class EducationCategoriesPage extends StatefulWidget {
  ...
  @override
  _EducationCategoriesPageState createState() => _EducationCategoriesPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: myAppBar(
        ...
        context,
        onBackBtnClicked: () {
          Provider.of<PageProvider>(context, listen: false).setPage(EducationPage.pageIndex, EducationPage());
        },
      ),
      body: WillPopScope(
        onWillPop: () async {
